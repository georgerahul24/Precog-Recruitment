...
def save_model(model, epoch, test_accuracy, base_path="GenerationModel4"):
    """
...
if os.path.exists('GenerationModel4'):
    os.system('rm -rf GenerationModel4')
os.makedirs('GenerationModel4', exist_ok=True)
