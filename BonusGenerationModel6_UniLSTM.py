...
def save_model(model, epoch, test_accuracy, base_path="GenerationModel6"):
    """
...
if os.path.exists('GenerationModel6'):
    os.system('rm -rf GenerationModel6')
os.makedirs('GenerationModel6', exist_ok=True)
