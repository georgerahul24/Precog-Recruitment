...
import shutil
shutil.rmtree('WordModelClassification', ignore_errors=True)
os.makedirs('WordModelClassification', exist_ok=True)
...
def train_and_record_model():
    ...
    for epoch in range(epochs):
        ...
        torch.save(model, f"WordModelClassification/model_{model_number}_{test_acc}.pth")
        model_number+=1
