...
input_dataset = CaptchaDataset(input_folder, char_to_idx, transform)
input_dataset.print_summary()
train_dataset, test_dataset = torch.utils.data.random_split(input_dataset, [int(0.8 * len(input_dataset)), len(input_dataset) - int(0.8 * len(input_dataset))])
