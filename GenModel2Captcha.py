...
# Custom Dataset
class CaptchaDatasetTrain(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image, target
class CaptchaDatasetTest(Dataset):
    def __init__(self, folder, char_to_idx, transform=None):
        self.folder = folder
        self.transform = transform
        self.image_paths = []
...
train_dataset = CaptchaDatasetTrain(train_folder, char_to_idx, transform)
train_dataset.print_summary()
train_dataloader = DataLoader(train_dataset, batch_size=32, shuffle=True, collate_fn=collate_fn)

test_dataset = CaptchaDatasetTest(test_folder, char_to_idx, transform)
